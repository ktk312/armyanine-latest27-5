...
//        if (selectedVaccination?.dog) {
//         console.log("dog is exist")
//       setSelectedDog({ value: selectedVaccination?.dog.id.toString(), label: selectedVaccination?.dog.dogName });
//       if (selectedVaccination?.dog.breed) {
//         setSelectedBreed({ value: selectedVaccination?.dog.breed.id.toString(), label: selectedVaccination?.dog.breed.breed });
//       }
//     }
//     }
//   }, [selectedVaccination]);
...
//    // resettin the setSelectedDog
//   useEffect(() => {
//   setSelectedDog(null); // reset dog selection
// }, [selectedBreed]);
...
// // console.log("check detail dog",selectedVaccination?.dog?.dogName, )
// // console.log("check detail breed", selectedVaccination?.dog?.breed)
