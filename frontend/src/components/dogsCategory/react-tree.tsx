...
const PedigreeTree: React.FC<{ dogId: number }> = ({ dogId }) => {
  ...
  return (
    ...
    >
      ...
      <div className="tree-container scrollbar-hide" ref={containerRef}>
        <div className="tree-section" style={{ minHeight: getTreeHeight(sireTree) }}>
          <h2 className="tree-title sire">Sire Pedigree</h2>
          {renderTree(sireTree, "Sire Pedigree")}
        </div>
        <div className="tree-section" style={{ minHeight: getTreeHeight(damTree) }}>
          <h2 className="tree-title dam">Dam Pedigree</h2>
          {renderTree(damTree, "Dam Pedigree")}
        </div>
