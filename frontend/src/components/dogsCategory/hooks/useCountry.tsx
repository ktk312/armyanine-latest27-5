...
export const useFetchCountries = () => {
  const { getAllCountry, country, countryLoading, Countryerror, selectedCountry, setSelectedCountry } = useCountryStore();

  useEffect(() => {
    getAllCountry();
  }, [getAllCountry]);

  return { country, countryLoading, Countryerror,selectedCountry, setSelectedCountry };
};
