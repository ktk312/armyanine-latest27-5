...
//                               }
//                             }}
//                             className="w-full rounded border border-gray-300 bg-white px-2 py-1 text-sm text-gray-900 placeholder-gray-400 shadow-sm transition-colors duration-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-500"
//                           />
//                         )}
//                       </div>
//                     </TableCell>
...
//                   <TableRow>
//                     <TableCell className="py-6 text-center text-gray-600 dark:text-gray-400">
...
//                         <button
//                           className="mx-1 rounded p-1 text-blue-600 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-400 dark:text-blue-400 dark:hover:bg-blue-900"
//                           onClick={() => openViewModal(dog)}
//                           aria-label="View Dog"
//                         >
