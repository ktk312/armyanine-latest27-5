...
export default function LitterRegistrationForm() {
    ...
    useEffect(() => {
        if (selectedLitter) {
            const sireOption = selectedLitter.sire ? { value: selectedLitter.sire.id.toString(), label: selectedLitter.sire.dogName } : null;
            const damOption = selectedLitter.dam ? { value: selectedLitter.dam.id.toString(), label: selectedLitter.dam.dogName } : null;
            const breedOption = selectedLitter.breed ? { value: selectedLitter.breed.id.toString(), label: selectedLitter.breed.breed } : null;
    ...
    return (
        <div>
            ...
            {/* Sire and Dam */}
            <h2 className="text-xl font-semibold mt-9 dark:text-white">Litter Parent</h2>
            ...
            <h2 className="text-xl font-semibold mt-9 dark:text-white">Puppies Information</h2>
            ...
            <div className="grid grid-cols-1 gap-6 xl:grid-cols-2 mt-2">
                ...
                <div>
                    ...
                    <Input type="text" id="input" name="location" placeholder="Enter location" value={selectedLitter?.location} onChange={handleChange} />
                </div>
            </div>
